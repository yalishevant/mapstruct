...
/**
 * Executes {@link LangModelSpiDescriptorContractProcessor} to confirm the SPI layer operates solely on descriptors and
 * the exposed {@link org.mapstruct.ap.spi.MapStructProcessingEnvironment} supplies neutral utilities.
 */
class LangModelSpiDescriptorContractTest {

    @Test
    void validatesSpiContractsOperateOnDescriptors() throws Exception {
        ...
        try ( StandardJavaFileManager fileManager = compiler.getStandardFileManager(
            ...
            options.add( "org.mapstruct.ap.test.langmodel.contract.LangModelSpiDescriptorContractProcessor" );
            ...
            assertThat( diagnostics.getDiagnostics() )
                ...
                .withFailMessage( () -> "SPI descriptor contract test failed:\n"
