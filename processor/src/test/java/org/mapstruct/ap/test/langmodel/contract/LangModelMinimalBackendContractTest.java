...
/**
 * Executes {@link LangModelMinimalBackendContractProcessor} to ensure optional capabilities emit friendly errors when
 * absent in a minimal backend scenario.
 */
class LangModelMinimalBackendContractTest {

    @Test
    void verifiesMinimalBackendContract() throws Exception {
        ...
        try ( StandardJavaFileManager fileManager = compiler.getStandardFileManager(
            ...
            options.add( "org.mapstruct.ap.test.langmodel.contract.LangModelMinimalBackendContractProcessor" );
            ...
            assertThat( diagnostics.getDiagnostics() )
                ...
                .withFailMessage( () -> "Minimal backend contract failed:\n"
