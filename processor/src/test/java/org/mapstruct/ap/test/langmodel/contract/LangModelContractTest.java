...
/**
 * Executes {@link LangModelContractProcessor} against the fixture sources to ensure the descriptor surface remains
 * compatible with the expectations of MapStruct's core processor.
 */
class LangModelContractTest {

    @Test
    void verifiesDescriptorContract() throws Exception {
        ...
        try ( StandardJavaFileManager fileManager = compiler.getStandardFileManager(
            ...
            options.add( "org.mapstruct.ap.test.langmodel.contract.LangModelContractProcessor" );
            ...
            assertThat( diagnostics.getDiagnostics() )
                ...
                .withFailMessage( () -> "Descriptor contract verification failed:\n"
                    + formatDiagnostics( diagnostics.getDiagnostics() ) )
                .isEmpty();

            assertThat( success )
                .as( () -> "Descriptor contract compilation failed:\n"
                    + formatDiagnostics( diagnostics.getDiagnostics() ) )
                .isTrue();
        }
    }
