...
/**
 * {@link AnnotationGemFactory} backed by {@code javax.lang.model}.
 */
final class JavaxAnnotationGemFactory implements AnnotationGemFactory {

    private static final JavaxAnnotationGemFactory INSTANCE = new JavaxAnnotationGemFactory();

    private JavaxAnnotationGemFactory() {
    }

    static JavaxAnnotationGemFactory instance() {
        return INSTANCE;
    }
    ...
    private <G> G instantiate(AnnotationDescriptor annotation, Function<AnnotationMirror, G> factory) {
        ...
        if ( annotation instanceof JavaxAnnotationDescriptor ) {
            return factory.apply( ( (JavaxAnnotationDescriptor) annotation ).mirror() );
        }
        return null;
    }
}
